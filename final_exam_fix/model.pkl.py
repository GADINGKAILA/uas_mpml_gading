...
feature_columns = ['Gender', 'Occupation', 'Monthly Income', 'Educational Qualifications', 'Feedback', 'Age', 'Family size', 'latitude', 'longitude', 'Pin code']
target_column = 'Marital Status'  # Replace with the actual target column name
